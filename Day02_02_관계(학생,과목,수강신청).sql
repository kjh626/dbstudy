...
CREATE TABLE SUBJECT_TBL(
    ...
    CONSTRAINT PK_SUB PRIMARY KEY(SJT_CODE)
);
...
CREATE TABLE ENROLL_TBL(
    ...
    CONSTRAINT FK_ENROLL_STUDENT FOREIGN KEY(STU_NO) REFERENCES STUDENT_TBL(STU_NO) ON DELETE CASCADE,  -- NOT NULL 이라 ON DELETE CASCADE
    CONSTRAINT FK_ENROLL_SUBJECT FOREIGN KEY(SJT_CODE) REFERENCES SUBJECT_TBL(SJT_CODE) ON DELETE CASCADE  -- 과목이 없어지면 과목 수강신청내역도 사라진다.
);
