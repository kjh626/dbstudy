-- 테이블의 구조 파악 -- 최대 4글자까지 줄일수 있다. DESCRIBE EMPLOYEES;
DESC EMPLOYEES;   
...
-- 10. EMPLOYEES 테이블의 사원들을 DEPARTMENT_ID순으로 조회하고, 동일한 DEPARTMENT_ID를 가진 사원들은 높은 SALARY 순으로 조회하시오.
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, DEPARTMENT_ID, SALARY
  FROM EMPLOYEES
 ORDER BY DEPARTMENT_ID ASC, SALARY DESC;    -- 2개 이상의 정렬조건은 ,로 연결해서 정렬해줘라. DEPARTMENT_ID, SALARY DESC 오름차순(ASC)은 생략 가능
