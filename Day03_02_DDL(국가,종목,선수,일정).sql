/*
    ...
    1. 기본키
        ...
        2) 삭제
            ALTER TABLE 테이블명 DROP PRIMARY KEY; -- 기본키는 한 테이블에 하나만 있을 수 있어서 그냥 PRIMARY KEY로도 삭제 가능.
...
-- 외래키 제약 조건 일시중지(비활성화)
ALTER TABLE PLAYER_TBL
    DISABLE CONSTRAINT FK_PLAYER_EVENT;    -- => PARENT KEY에 값이 없어도 입력이 가능. 먼저 입력을 시켜놓고 나중에 수정을 하겠다.이런 경우에 쓴다. 편의를 위해서
